...
var WorkflowBusinessStruct map[string]func() SdWorkflow
var WorkflowBusinessTable map[string]func() interface{}

type SdWorkflow interface {
...
func (w WorkflowBase) CreateWorkflowMove() (businessModel *WorkflowMove) {
	return &WorkflowMove{
		SdModel:         global.SdModel{ID: w.WorkflowMoveID},
...
type WorkflowProcess struct {
	...
	Name        string         `json:"name" form:"name" gorm:"comment:流程名称"`
	Category    string         `json:"category" gorm:"comment:分类"`
	Clazz       string         `json:"clazz" gorm:"comment:类型"`
	Label       string         `json:"label" form:"label" gorm:"comment:流程标题"`
